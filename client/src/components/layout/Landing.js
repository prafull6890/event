  ...
  <section>
    ...
    <h2 style={{color:"black"}}>Our Team</h2>
      ...
      <div class="col-xl-3 col-sm-6 mb-5" style={{marginLeft:"150px",width:"250px",height:"150px" }}>
        <div class="bg-white rounded shadow-sm py-5 px-4" style={{borderRadius:"10px",border:"#17a2b8 solid 4px"}}><img src={Shubham}  alt="" style={{marginLeft:"50px",backgroundColor:"#17a2b8 ",width:"100px",height:"100px" }} class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
          <h5 class="mb-0"  style={{textAlign:"center" }}>Shubham Rane</h5><span class="small text-uppercase text-muted"style={{marginLeft:"50px" }}>CEO - Founder</span>
      ...
      <div class="col-xl-3 col-sm-6 mb-5" style={{width:"250px",height:"150px" }}>
        <div class="bg-white rounded shadow-sm py-5 px-4" style={{border:"#17a2b8 solid 4px"}}><img src={Prafull}  alt="" style={{backgroundColor:"#17a2b8 ",marginLeft:"50px",width:"100px",height:"100px" }}class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
          <h5 class="mb-0"style={{textAlign:"center" }}>Prafull chavan</h5><span class="small text-uppercase text-muted" style={{marginLeft:"50px" }}>CEO - Founder</span>
          <ul class="social mb-0 list-inline mt-3">
            <li class="list-inline-item"><a href="#" class="social-link"><FontAwesomeIcon icon={faLinkedin} /></a></li>
            <li class="list-inline-item"><a href="#" class="social-link"><FontAwesomeIcon icon={faFacebook} /></a></li>
            <li class="list-inline-item"><a href="#" class="social-link"><FontAwesomeIcon icon={faInstagram} /></a></li>
      ...
      <div class="col-xl-3 col-sm-6 mb-5" style={{width:"250px",height:"150px" }}>
        <div class="bg-white rounded shadow-sm py-5 px-4" style={{border:"#17a2b8 solid 4px"}}><img src={Chaitanya}  alt=""  style={{backgroundColor:"#17a2b8 ",marginLeft:"50px",width:"100px",height:"100px" }} class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
          <h5 class="mb-0" style={{textAlign:"center" }} >Chaitanya Aayre</h5><span class="small text-uppercase text-muted" style={{marginLeft:"50px" }}>CEO - Founder</span>
          <ul class="social mb-0 list-inline mt-3">
            <li class="list-inline-item"><a href="#" class="social-link"><FontAwesomeIcon icon={faLinkedin} /></a></li>
            <li class="list-inline-item"><a href="#" class="social-link"><FontAwesomeIcon icon={faFacebook} /></a></li>
            <li class="list-inline-item"><a href="#" class="social-link"><FontAwesomeIcon icon={faInstagram} /></a></li>
